export function Hero() {
  ...
  return (
    <section className="min-h-[60vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 relative bg-cover" style={{ backgroundImage: "url('/pexels-kaip-1082809.jpg')", backgroundPosition: 'center bottom' }}>
